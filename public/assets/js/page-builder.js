(() => {
  ...
  const blockName = (blockOrType) => {
    ...
    const names = { hero: 'Hero banner', image_text: 'Image + text', centered_intro: 'Centered introduction', values: 'Trust / value strip', cards: 'Featured cards', gallery: 'Image gallery', testimonials: 'Testimonials', faq: 'FAQ', stats: 'Statistics', custom: 'Custom section', latest_posts: 'Latest blog posts', collection: 'Connected content', cta: 'Call to action', pattern: 'Synced pattern' };
  ...
  const editorFor = (block) => ({ hero: heroEditor, values: valuesEditor, cards: cardsEditor, gallery: galleryEditor, testimonials: testimonialsEditor, faq: faqEditor, stats: statsEditor, custom: customEditor, latest_posts: latestEditor, collection: collectionEditor, cta: ctaEditor, pattern: patternEditor }[block.type] || (() => '<p>Unsupported block.</p>'))(block);
  ...
  richEditable?.addEventListener('input', () => {
    ...
    const commands = { '/hero': 'hero', '/image': 'image_text', '/values': 'values', '/cards': 'cards', '/gallery': 'gallery', '/quotes': 'testimonials', '/faq': 'faq', '/stats': 'stats', '/section': 'custom', '/posts': 'latest_posts', '/collection': 'collection', '/content': 'collection', '/cta': 'cta' };
